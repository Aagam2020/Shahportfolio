...
<div class='tableauPlaceholder' id='viz1732562491000' style='position: relative'>
  <noscript>
    <a href='#'>
      <img alt='Sheet 2' 
           src='https://public.tableau.com/static/images/ag/agerangedepressionchart/Sheet2/1_rss.png' 
           style='border: none' />
    </a>
  </noscript>
  <object class='tableauViz' style='display: none;'>
    ...
    <param name='name' value='agerangedepressionchart/Sheet2' />
    <param name='tabs' value='no' />
    <param name='toolbar' value='yes' />
    <param name='static_image' value='https://public.tableau.com/static/images/ag/agerangedepressionchart/Sheet2/1.png' />
...
<script type='text/javascript'>
  var divElement = document.getElementById('viz1732562491000');
...
<div class='tableauPlaceholder' id='viz1732566156848' style='position: relative'>
  <noscript>
    <a href='#'>
      <img alt='SAHMSA CHART' 
           src='https://public.tableau.com/static/images/sa/sahmsachart/SAHMSACHART/1_rss.png' 
           style='border: none' />
    </a>
  </noscript>
  <object class='tableauViz' style='display: none;'>
    ...
    <param name='embed_code_version' value='3' />
    <param name='site_root' value='' />
    <param name='name' value='sahmsachart/SAHMSACHART' />
    <param name='tabs' value='no' />
    <param name='toolbar' value='yes' />
    <param name='static_image' value='https://public.tableau.com/static/images/sa/sahmsachart/SAHMSACHART/1.png' />
    <param name='animate_transition' value='yes' />
    <param name='display_static_image' value='yes' />
    <param name='display_spinner' value='yes' />
    <param name='display_overlay' value='yes' />
...
<script type='text/javascript'>
  var divElement = document.getElementById('viz1732566156848');
  var vizElement = divElement.getElementsByTagName('object')[0];
  vizElement.style.width = '100%';
  vizElement.style.height = (divElement.offsetWidth * 0.75) + 'px';
  var scriptElement = document.createElement('script');
...
<div class='tableauPlaceholder' id='viz1732564126222' style='position: relative'>
  <noscript>
    <a href='#'>
      <img alt='Depression among 18-25 year olds from 2015 to 2020' 
           src='https://public.tableau.com/static/images/de/depressionovertheyears/Sheet3/1_rss.png' 
           style='border: none' />
    </a>
  </noscript>
  <object class='tableauViz' style='display: none;'>
    ...
    <param name='embed_code_version' value='3' />
    <param name='site_root' value='' />
    <param name='name' value='depressionovertheyears/Sheet3' />
    <param name='tabs' value='no' />
    <param name='toolbar' value='yes' />
    <param name='static_image' value='https://public.tableau.com/static/images/de/depressionovertheyears/Sheet3/1.png' />
    <param name='animate_transition' value='yes' />
    <param name='display_static_image' value='yes' />
    <param name='display_spinner' value='yes' />
    <param name='display_overlay' value='yes' />
...
<script type='text/javascript'>
  var divElement = document.getElementById('viz1732564126222');
  var vizElement = divElement.getElementsByTagName('object')[0];
  vizElement.style.width = '100%';
  vizElement.style.height = (divElement.offsetWidth * 0.75) + 'px';
  var scriptElement = document.createElement('script');
