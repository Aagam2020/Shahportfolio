...
I chose this data visualization from Google Trends because it highlights the growing and then eventually falling popularity and interest in AI image generation tools such as Midjourney, Stable Diffusion, and DALL-E over the past two years. These tools have significantly impacted the fields of digital art, content creation, and AI-driven media, capturing both public and professional attention. It also showcases it's downfall because from my research, other better and more relvant tools were invented and released in the market.

This visualization is particularly relevant as it allows us to see the comparative interest in these tools over time, showcasing trends in user engagement and public curiosity. The information is useful for understanding which platforms are gaining traction and could potentially inform decisions in fields ranging from marketing to AI research.
...
## Why I Care
As someone deeply interested in artificial intelligence and AI tools, I found this graph really interesting . These tools have revolutionized content creation, making complex image generation accessible to a wide range of users—from professional artists to hobbyists. By analyzing these popularity trends, I can gain insights into which tools are resonating most with users, and which ones I should use when and if the need be. 
...
## The Story the redesigned Graph Tells:
...
- **DALL-E** shows a sharp peak at its launch, indicating a high initial curiosity and engagement. As mentioned in the redesigned graph, it was when DALL-E launched that it's populairty was at it's peak and then it gradually declined. 
...
2. **Event Annotations**: There is a desire for slightly more detailed annotations, explaining the significance of events which would give them more context into what the major changes actually mean relating to the story the grpah is trying to tell.
...
4. **Peak Popularity Line**: Both participants understood its purpose but recommended adding a note clarifying that it represents the maximum interest (100). This would add context and also comparability among the different lines in the visualization. 
...
### Iteration on the Previous Graph: Tracking AI Tool Popularity

This is an updated version of the previous visualization on AI tool popularity.
<!-- Iteration on the previous graph: Tracking AI Tool Popularity -->
<div class="tableauPlaceholder" id="viz1731451815506" style="position: relative;">
    <noscript>
        <a href="#">
            <img alt="Tracking AI Tool Popularity" src="https://public.tableau.com/static/images/Mu/MutlilineAITool/Sheet12/1_rss.png" style="border: none" />
        </a>
    </noscript>
    <object class="tableauViz" style="display: none;">
        <param name="host_url" value="https%3A%2F%2Fpublic.tableau.com%2F" />
        <param name="embed_code_version" value="3" />
        <param name="site_root" value="" />
        <param name="name" value="MutlilineAITool/Sheet12" />
        <param name="tabs" value="no" />
        <param name="toolbar" value="yes" />
        <param name="static_image" value="https://public.tableau.com/static/images/Mu/MutlilineAITool/Sheet12/1.png" />
        <param name="animate_transition" value="yes" />
        <param name="display_static_image" value="yes" />
        <param name="display_spinner" value="yes" />
        <param name="display_overlay" value="yes" />
...
<script type="text/javascript">
    var divElement = document.getElementById("viz1731451815506");
    var vizElement = divElement.getElementsByTagName("object")[0];
    vizElement.style.width = "100%";
    vizElement.style.height = (divElement.offsetWidth * 0.75) + "px";
    var scriptElement = document.createElement("script");
...
In the above graph, I focused on using a different data visualization (area graph) to showcase how much of the AI image generation space does each tool cover and also I changed the color of the annotations to match with the color of the line, to make it look more aesthetic.  

# Summary

## Description and Reason for Selection
I chose to analyze and redesign a data visualization from Google Trends that tracks the popularity of AI image generation tools—Midjourney, Stable Diffusion, and DALL-E—over the past two years. This visualization is relevant for understanding trends in digital art and AI, highlighting which tools have gained the most public attention over time. I am interested in the AI space quite a bit and the tools made with AI, so this fit perfectly in that interest regions and hence why I chose it.

## Initial Critique and Redesign Considerations
When critiquing the original visualization, I identified several areas for improvement. First, the legend clarity and line colors were somewhat faint, making it hard to distinguish between tools. Additionally, the chart did not includ labeled points marking events like tool launches, but just had peaks and troughs which were hard to understand the significance of these points. Another element, the peak popularity line, indicated the maximum popularity at 100 but lacked a label to explain its meaning. Finally, there was an additional average popularity chart, but it was positioned in a less prominent area. These observations informed my initial redesign goals: to enhance clarity, add context to event markers, improve color contrast, and make the average values and peak line more informative.
...
I interviewed two participants (both students of CMU in their mid-20s) to gather feedback on the redesigned sketch.
